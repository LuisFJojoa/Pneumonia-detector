...
class App:
    ...
    def load_img_file(self):
        ...
        if filepath:
            self.array, img2show = ImageLoader.load_image(filepath)
    ...
    def run_model(self):
        self.label, self.proba, self.heatmap = self.model_strategy.predict(self.array)
...
def main():
    ...
    App(image_processor, model_strategy, grad_cam)
    return 0
